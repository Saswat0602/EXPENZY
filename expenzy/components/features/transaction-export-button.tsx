...
import { useExportTransactions } from '@/lib/hooks/use-export';
import type { ExportTransactionsOptions } from '@/types/export';
...
export function TransactionExportButton({
    ...
    const handleExport = async () => {
        const options: ExportTransactionsOptions = {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Export your income and expenses as a PDF report.
                    </DialogDescription>
                </DialogHeader>
